...
class Server{
	...
	public function about(){
		$string = "§b
                ########################  
		#        ___________   #  
		#       /          /   #  §aMinecraft: PE Version§7: §f" . $this->getVersion() . "§b
		#      /          /    #  §aProtocol Version§7: " . ProtocolInfo::CURRENT_PROTOCOL . "§b
		#     /          /     #  §aAPI§7: §f" . $this->getApiVersion() . "§b
		#    /__________/      #  
		#                      #  §l§aBamSoftware die §cBam§eCraft§bPE §aServer Software§r§b
		########################  
